                        ...
                        <div class="blog-box">
                            ...
                            <div class="blog-content">
                                <div class="title-blog">
                                    <h3>{{$blog->title}}</h3>
                                    <p>{{strip_tags(substr($blog->content, 0,100))}}</p>
                                </div>
                                <ul class="option-blog">
                                    <li><a href="{{route('blogDetail', $blog->id)}}"><i class="far fa-heart"></i></a>
                                    </li>
                                    <li><a href="{{route('blogDetail', $blog->id)}}"><i class="fas fa-eye"></i></a></li>
                                    <li><a href="{{route('blogDetail', $blog->id)}}"><i class="far fa-comments"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
