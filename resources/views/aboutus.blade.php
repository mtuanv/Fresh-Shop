...
@section("content")
    ...
    <div class="about-box-main">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="banner-frame"><img class="img-fluid" src="{{asset('shop/images/about-img.jpg')}}" alt=""/>
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row my-4">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="hover-team">
                        <div class="our-team"><img src="{{asset('shop/images/img-1.jpg')}}" alt=""/>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="hover-team">
                        <div class="our-team"><img src="{{asset('shop/images/img-2.jpg')}}" alt=""/>
                            <div class="team-content">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="hover-team">
                        <div class="our-team"><img src="{{asset('shop/images/img-3.jpg')}}" alt=""/>
                            <div class="team-content">
