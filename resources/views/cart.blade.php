                        ...
                        <table class="table">
                            ...
                            <tr>
                                <td class="thumbnail-img">
                                    <a href="#">
                                        <img class="img-fluid" src="{{asset('shop/images/img-pro-01.jpg')}}" alt=""/>
                                    </a>
                                </td>
                                <td class="name-pr">
                                    <a href="#">
                            ...
                            <tr>
                                <td class="thumbnail-img">
                                    <a href="#">
                                        <img class="img-fluid" src="{{asset('shop/images/img-pro-02.jpg')}}" alt=""/>
                                    </a>
                                </td>
                                <td class="name-pr">
                                    <a href="#">
                            ...
                            <tr>
                                <td class="thumbnail-img">
                                    <a href="#">
                                        <img class="img-fluid" src="{{asset('shop/images/img-pro-03.jpg')}}" alt=""/>
                                    </a>
                                </td>
                                <td class="name-pr">
                                    <a href="#">
